...
<head>
    ...
    <title>Create New Trip | Wasslny</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar bg-white p-4 position-fixed" style="width: 280px;">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link active" href="/driver/trips/new">
        ...
        <div class="main-content flex-grow-1">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-plus-circle"></i> Create New Trip</h5>
                </div>
                <div class="card-body">
                    <form:form method="post" action="/driver/trips/new" modelAttribute="trip">
                        <div class="row g-3">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <form:input path="maximumPassengers" type="number" class="form-control" id="maximumPassengers" placeholder="Maximum Passengers"/>
